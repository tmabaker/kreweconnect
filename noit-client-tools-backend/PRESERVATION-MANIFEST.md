...
## Interfaces
- [ ] `IGdapService.cs` — `01GX36IQCAC42ST743YJA3F4YNEKNTOKXC`
- [ ] `IEmployeeService.cs` — `01GX36IQDYKJDUBDJGWNBLD4W5WAZFJJ4N`
- [ ] `IEmployeeSyncService.cs` — `01GX36IQGHDXNCRQFCGBBLFTU75TBT6XD5`
- [ ] `IContractService.cs` — `01GX36IQFYPHCQDRQKKNEY3ZPFD7SRYQID`
- [ ] `IContractApprovalService.cs` — `01GX36IQGZVR6BYRUB6ZGYULTUWYPGSGJT`
- [ ] `IRenewalAlertService.cs` — `01GX36IQGGR5KB3SYOH5D3DBZMZRTQ5PRO`
- [ ] `IAuditService.cs` — `01GX36IQEZNHHCXW62KJHJLEBABELJN6HB`
- [ ] `ITenantContext.cs` — `01GX36IQBNS6TXN4SA6FE35J7ZKBZ75LL2`
...
- [ ] `ContractDtos.cs` — `01GX36IQBX3Y5ALEAAIFCIXPUJ4GKO4OE7`
- [ ] `TenantDtos.cs` — `01GX36IQEBGVDC5L5S4BAKCJS3KXNV2R5W`
- [ ] `UserDtos.cs` — `01GX36IQAXBVHGIJP6JBDZKOBSVY76RUCT`
- [ ] `GdapRelationshipDto.cs` — `01GX36IQEGQ6PMGZ2EXNFLRV5GQ3NPDDYD`
